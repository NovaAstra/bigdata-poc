...
})({"6hLb0":[function(require,module,exports,__globalThis) {
...
class Heap {
    ...
    #_heapifyDown() {
        ...
        while(this.#_hasLeftChild(index)){
            ...
            if (this.#_hasRightChild(index) && this.#_comparator(this.#_getLeftChild(index), this.#_getRightChild(index))) smallestChildIndex = this.#_getRightChildIndex(index);
            if (this.#_comparator(this.heap[smallestChildIndex], this.heap[index])) break;
    ...
    #_validate() {
        if (this.sizes === 0) throw new Error('Invalid Operation. Heap is Empty');
    }
    #_swap(indexA, indexB) {
...
function sort(arrays = [], comparator = (a, b)=>a > b) {
    const minHeap = new MinHeap((a, b)=>comparator(a.value, b.value));
    const result = [];
    console.log(1);
    for(let id = 0; id < arrays.length; id++)if (arrays[id].length > 0) minHeap.push({
        value: arrays[id][0],
        id,
        index: 0
    });
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"5G1e8"}],"5G1e8":[function(require,module,exports,__globalThis) {
...
},{}]},["6hLb0","4ZGjQ"], "4ZGjQ", "parcelRequire22e0", {})

//# sourceMappingURL=bigdata-poc.f72d0d54.js.map
